...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-11 col-md-8 col-sm-8 col-xs-8">
			<div id="uploadpi">
				<form action="${path}/simple/deploy.do" method="post"
					enctype="multipart/form-data" class="form-inline">
					<div class="fileinput fileinput-new" data-provides="fileinput">
						<div class="input-group">
							<div class="form-control span3" data-trigger="fileinput">
								<i class="glyphicon glyphicon-file fileinput-exists"></i> <span
									class="fileinput-filename"></span>
							</div>
							<span class="input-group-addon btn btn-default btn-file"><span
								class="fileinput-new">选择文件</span><span class="fileinput-exists">重选</span><input
