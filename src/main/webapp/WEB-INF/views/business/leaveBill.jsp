...
<script type="text/javascript">
	...
	function request(){
		...
		//alert(row.id);
		window.location.href=path+"/leaveflow/start.action?id="+row.id;
		/* $("#b").hide();
		$("#a").show(); */
	}
	...
	function addflow() {
		$("#dlg").dialog('open').dialog('setTitle', '添加假单');
	...
	function addLeaveBill(){
		...
		var url = path+'/leaveBill/addLeaveBill.action';
		$.ajax({
			type:'post',
			dataType:'json',
			url:url,
	...
	function delopen() {
		...
		$("#rids").val(row.id);
		var url = "${path}/workflow/comment.action?id="+row.id ;
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		<table id="datagrid" class="easyui-datagrid" fit="true"
			url=" ${path }/leaveBill/getInfo.action " toolbar="#toolbar"
			...
			<thead>
				<tr>
					...
					<th field="name" width="100">请假人</th>
					<th field="days" width="100">请假天数</th>
					<th field="content" width="100">请假原因</th>
					<th field="remark" width="100">请假备注</th>
					<th field="leaveDate" width="100">请假日期</th>
					<th field="status" width="100">请假状态</th>
	...
	<!-- 添加/修改对话框 -->
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post" novalidate>
				...
				<div class="fitem">
					<label>请假天数:</label> <input name="days" class="easyui-textbox" >
				</div>
				<div class="fitem">
					<label>请假原因:</label> <input name="content" class="easyui-textbox" >
				</div>
				<div class="fitem">
					<label>请假备注:</label> 
				...
				<div class="fitem">
					<label>请假日期:</label> <input name="leaveDate" type="text" class="easyui-datebox" />
				</div>
				<!-- <div class="fitem">
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="addLeaveBill()" style="width:90px">保存</a> 
				<a href="javascript:void(0)" class="easyui-linkbutton"
